...
<head>
  ...
  <meta name="msapplication-TileImage" content="maring-main-html/maring-main-html/favicon/ms-icon-144x144.png" />
              ...
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a href="internet/about-internet.html" class="dropdown-item">About the Internet</a>
                    <a href="internet/history-internet.html" class="dropdown-item">History of the Internet</a>
                    ...
                    <a href="internet/accessing-internet.html" class="dropdown-item">Gaining access to the Internet</a>
                    <a href="internet/how-https-works.html" class="dropdown-item">How HTTPS works</a>
                  </div>
                </li>
              </ul>
